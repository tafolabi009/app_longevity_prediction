...
def main():
    # Expanded list of app IDs to collect data from (100+ apps)
    app_ids = {
        "iOS": [
            ...
            "642395579",  # Clash of Clans
            "489321253",  # Subway Surfers
            "406889139",  # Fruit Ninja
            "529479190",  # Minecraft
            "1118692613", # Pokemon GO
            "481796669",  # Roblox
            "509338362",  # Angry Birds 2
            "1176027022", # Fortnite
        ...
        "Android": [
            ...
            "com.fooducate.nutritionapp", # Fooducate
            "com.urbandroid.sleep",      # Sleep Cycle
            "com.strava",                # Strava
            ...
            "com.readdle.Scanner",       # Scanner Pro
            "com.whatsapp",              # WhatsApp
            "com.skype.raider",          # Skype
            "com.google.android.gm",     # Gmail
            "com.google.android.apps.maps", # Google Maps
    ...
    with ThreadPoolExecutor(max_workers=5) as executor:  # Reduced workers to avoid rate limits
        ...
        for platform, ids in app_ids.items():
            for app_id in ids:
                ...
                time.sleep(1.5)  # Increased delay between submissions to avoid rate limits
